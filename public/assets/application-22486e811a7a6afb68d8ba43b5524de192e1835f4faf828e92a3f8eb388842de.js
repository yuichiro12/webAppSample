...
(function() {
  $(function() {
    ...
    $("input.skill-submit").click(function(e) {
      var t_area, target;
    ...
    $("div#skill-list").on("click", "button[data-plus1]", function() {
      var target;
      target = $(this);
      target.prop("disabled", true);
      $.ajax({
        ...
        success: function(data) {
          return target.text(data.point);
        }
      });
      return target.prop("disabled", false);
    });
    $("div#skill-list").on("click", "span.remove-skill", function() {
      var target;
      target = $(this);
      target.prop("disabled", true);
      $.ajax({
        ...
        success: function(data) {
          return $("div#skill-list").html(data);
        }
      });
      return target.prop("disabled", false);
    });
